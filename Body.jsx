        ...
        <Fragment>
            ...
            <div className='bg-[#f1eef7]'>
                <div className="mx-auto lg:pt-10 lg:px-12">
                    <div className="grid py-20 gap-5 sm:grid-cols-1 items-center p-6 lg:px-20 lg:grid-cols-2 md:grid-cols-2">
                        <div className="grid lg:justify-items-center">
                            <div>
                                ...
                                <p className="md:text-md text-md py-5 font-normal text-[#2A2346] animate-once animate-delay-400 animate__animated animate__zoomIn"><b>Discover, Book  and Get Booked</b> All in one platform, it only takes a few <br /> clicks to get started. Be the first to experience the event revolution <br /> by Joining our community!</p>
                                <div className='hidden lg:block'>
                                    <GlassInput />
                                </div>
                                <div className='lg:hidden'>
                                    <Button variant="gradient" color="white" className='font-family w-48 capitalize bg-[#2A2346] text-[#F1EEF7]'>
                                        Join Waitlist
                                    </Button>
                                </div>
                                <div className='mt-5 animate-delay-400 animate__animated animate__zoomIn'>
                                    <p className='text-[#2A2346] text-sm mb-2'>Our Waitlist</p>
                                    <AvatarStack />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid gap-5 sm:grid-cols-1 items-center p-6 lg:px-2 lg:grid-cols-3">
                            ...
                            <div className='col-span-2'>
                                <ScrollAnimation duration={1} animateIn="fadeInLeft" animateOnce={true}>
                                    ...
                                    <p className='text-lg leading-relaxed mt-5 max-w-2xl'>
                                    ...
                                    <p className='my-2 max-w-2xl text-lg'>Imagine a platform where you can easily find the perfect venue, caterer, entertainment, and more, all at your fingertips<span className='lg:hidden'>...</span>.</p>
                                    <p className='my-2 max-w-2xl text-lg hidden lg:block'>Organizing events has never been easy and that is why we aim to simplify that process, providing a dedicated space for effective service marketing.</p>
                                    <div className='inline-flex items-center lg:hidden'>
                                        <h5 className='my-5 capitalize font-family text-[#8563A6]'>Read more </h5>
                        ...
                        <div className="">
                            <ScrollAnimation className='grid gap-5 sm:grid-cols-1 items-center p-6 lg:px-2 lg:grid-cols-3' duration={1} animateIn="fadeInUp" animateOnce={true}>
                                <div className='bg-[#ffffff] w-full lg:max-w-64 rounded-2xl'>
                                    <h3 className='text-lg text-[#2A2346] font-bold p-6'>Where Party Is <br /> Made Flexible</h3>
                                    <img src={rec1} className='w-40 float-end' />
                                </div>

                                <div className='bg-[#ffffff] w-full lg:max-w-64 rounded-2xl'>
                                    <h3 className='text-lg text-[#2A2346] font-bold p-6'>Imagination <br /> Meets Creativity</h3>
                                    <img src={rec2} className='w-40 float-end' />
                                </div>

                                <div className='bg-[#ffffff] w-full lg:max-w-64 rounded-2xl'>
                                    <h3 className='text-lg text-[#2A2346] font-bold p-6'>To Set Memorable <br /> Magical Moment</h3>
                                    <img src={rec3} className='w-40 float-end' />
                                </div>
                            </ScrollAnimation>
                        </div>
                    </div>
                            ...
                            <div className="lg:max-w-7xl">
                                <ScrollAnimation className='grid gap-5 sm:grid-cols-1 items-center p-6 lg:px-2 lg:grid-cols-3' duration={1} animateIn="fadeInUp" animateOnce={true}>
                                    <div className='bg-[#ffffff] w-full lg:max-w-lg rounded-2xl col-start-1 col-end-7 lg:col-start-1 lg:col-end-4'>
                                        <h3 className='text-lg text-[#2A2346] font-bold p-6'>Feteflex For Your <br /> Events</h3>
                                        <div className='grid gap-5 sm:grid-cols-1 items-center p-6 lg:grid-cols-2'>
                                            <p>Browse through a diverse range of options, by location, vendor type, budget to find exactly what they need.</p>
                                            <div className='justify-items-end'>
                                                <img src={iphone1} className='w-40 float-end' />
                                            </div>
                                        </div>
                                    </div>

                                    <div className='bg-[#ffffff] w-full max-w-lg rounded-2xl col-start-1 col-end-7 lg:col-end-7 lg:col-span-2'>
                                        <h3 className='text-lg text-[#2A2346] font-bold p-6'>Feteflex For Service <br /> Providers</h3>
                                        <div className='grid gap-5 sm:grid-cols-1 items-center p-6 lg:grid-cols-2'>
                                            <p>Event service providers now have the chance to showcase their unique offerings, and attract more clients</p>
                                            <div className='justify-items-end'>
                                                <img src={iphone2} className='w-40 float-end' />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='bg-[#ffffff] w-full max-w-fit rounded-2xl col-start-1 col-end-7'>
                                        <div className='grid gap-5 sm:grid-cols-1 items-end lg:grid-cols-3'>
                                            <div className='lg:col-span-2 my-5 px-6'>
                                                ...
                                                <p className='w-full max-w-lg my-4'>Our escrow payment system ensures that funds are held securely until services are successfully delivered, providing peace of mind and mitigating financial disputes for you and your client.</p>
                                                <Button variant="gradient" color="white" className='font-family w-48 capitalize bg-[#2A2346] text-[#F1EEF7]'>
                                                    Join Waitlist
                                                </Button>
                                            </div>
